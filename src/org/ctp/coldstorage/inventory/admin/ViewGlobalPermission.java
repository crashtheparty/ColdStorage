...
public class ViewGlobalPermission implements ColdStorageInventory, Anvilable{
	...
	public ViewGlobalPermission(OfflinePlayer player, Permission permission) {
		this.player = player;
	...
	public ViewGlobalPermission(OfflinePlayer player, OfflinePlayer admin, Permission permission) {
		this.player = player;
		this.admin = admin;
