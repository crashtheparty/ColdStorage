...
public class ViewPermission extends ColdStorageData implements Anvilable {
	...
	public ViewPermission(Player player, OfflinePlayer editing, Permission permission) {
