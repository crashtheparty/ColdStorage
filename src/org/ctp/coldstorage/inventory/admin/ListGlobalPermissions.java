...
public class ListGlobalPermissions implements ColdStorageInventory, Anvilable{
	...
	public ListGlobalPermissions(OfflinePlayer player) {
		this.player = player;
	...
	public ListGlobalPermissions(OfflinePlayer player, OfflinePlayer admin) {
		this.player = player;
		this.admin = admin;
	...
	public void setInventory() {
		...
		for(int i = 0; i < PAGING; i++) {
			...
			permissionItemMeta.setDisplayName(ChatUtils.getMessage(permissionCodes, "inventory.listglobalpermissions.permission"));
			...
			lore.addAll(ChatUtils.getMessages(loreCodes, "inventory.listglobalpermissions.permission_lore"));
		...
		createMeta.setDisplayName(ChatUtils.getMessage(getCodes(), "inventory.create_remove.create_global_permission"));
