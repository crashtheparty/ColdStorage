	...
	public void setInventory() {
		...
		if (itemStack.getType() == Material.AIR) {
			...
			takeAllLore.addAll(getChat().getMessages(getCodes(new HashMap<String, Object>() {
				{
					put("%stored_amount%", storage.getStoredAmount());
					put("%max_size%", maxAmount);
				}
			...
			importChestMeta.setLore(getChat().getMessages(getCodes("%max_import%", storage.getStorageType() != null ? storage.getStorageType().getMaxImport() : 0), "inventory.viewstorage.edit_import_chest"));
			...
			exportChestMeta.setLore(getChat().getMessages(getCodes("%max_export%", storage.getStorageType() != null ? storage.getStorageType().getMaxExport() : 0), "inventory.viewstorage.edit_export_chest"));
