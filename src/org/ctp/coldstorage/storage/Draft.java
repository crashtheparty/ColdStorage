...
public class Draft extends Cache {
	...
	public boolean canBuy() {
		return !tooManyTotal() && !tooManyType() && !zeroType() && getPlayer() != null && getUnique() != null && getMaterial() != null && getMaterial() != Material.AIR && getStorageType() != null && getName() != null && !getName().equals("");
	}
